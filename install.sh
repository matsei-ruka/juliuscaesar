...
BINARIES=(jc jc-memory jc-heartbeat jc-voice jc-watchdog jc-workers jc-skills jc-research jc-gateway jc-init jc-setup jc-doctor jc-upgrade jc-update jc-migrate-to-0.3 jc-migrate-to-0.3-commitments jc-company jc-chats jc-email jc-transcripts jc-commitments jc-dream jc-user-model jc-codex-auth jc-self-model jc-persona jc-completion)
